...
function Home() {
  ...
  const getTransactions = async () => {
    try {
      ...
      const response = await axios.post(
        "https://web-production-4c51b.up.railway.app/api/transactions/get-all-transactions",
        {
          userid: user._id,
          frequency,
  ...
  const deleteTransaction = async (record) => {
    try {
      setLoading(true);
      await axios.post("https://web-production-4c51b.up.railway.app/api/transactions/delete-transaction", {
